...
import commons.AbtractTest as AbtractTest
	...
	partyOnboarding.clickLineofBusiness(s05_lineofbusiness, findTestObject('PartyOnboarding/PartyOnboarding/div_Core Banking'))
	...
	partyOnboarding.clickNextbutton()
	log.logInfo("---UT-48 Step0" + steps + " Input Party Required Documents - Record PartyID ---")
	partyOnboarding.recordPartyId()
	log.logInfo("---UT-48 Step0" + steps + " Input Party Required Documents - Verify Confirmation screen and record data---")
	results += "|" + steps + "," + partyOnboarding.isPersonalPartyConfirmationDisplayed()	
	
	steps = "13"	
	log.logInfo("---UT-48 Step0" + steps + " Ask For Approve - Click Next button ---")
	partyOnboarding.clickNextbutton()
	log.logInfo("---UT-48 Step0" + steps + " Ask For Approve - Click Ask For Approval button ---")
	partyOnboarding.clickAskForApprovalbutton()
	results += "|" + steps + ",PASSED"
