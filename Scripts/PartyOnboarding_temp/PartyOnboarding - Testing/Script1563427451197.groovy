...
WebUI.click(findTestObject('Object Repository/Testing_SELENIUM WEBDRIVER FORM DEMO/Page_FusionBanking/input_Local Global'), FailureHandling.STOP_ON_FAILURE)

CustomKeywords.'commons.abtractPage.verifyDropDownList'(findTestObject('Object Repository/Testing_SELENIUM WEBDRIVER FORM DEMO/Page_FusionBanking/div_Global'),dropdownlisttesting)
...
//WebUI.callTestCase(findTestCase('PartyOnboarding_temp/Pre-Existence Check/Pre-Existence Check'), [('firstname') : pre_firstname
...
//
//WebUI.callTestCase(findTestCase('PartyOnboarding_temp/PersonalParty/PersonalParty'), [('chk_TaxPayer') : person_chk_TaxPayer, ('civilStatus') : person_civilStatus
...
//
//WebUI.callTestCase(findTestCase('PartyOnboarding_temp/PartyAddress/PartyAddress'), [('addresstype') : add_addresstype, ('addressstatus') : add_addressstatus
...
//
//WebUI.callTestCase(findTestCase('PartyOnboarding_temp/PartyContact/PartyContact'), [('email') : contact_email, ('confirmemail') : contact_confirmemail
...
//
//WebUI.callTestCase(findTestCase('PartyOnboarding_temp/PartyDocument/RequireDocuments'), [('documenttype') : doc_documenttype, ('documentverified') : doc_documentverified
