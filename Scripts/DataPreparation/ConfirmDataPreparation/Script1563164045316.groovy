...
notificationPage.clickConfirmed(description,'Approval' )

//step="4"
//log.logInfo("Confirmation - Step0" + step + " Tick to Denote Compliance")
//notificationPage.clickDenoteCompliance()
//
//step="5"
//log.logInfo("Confirmation - Step0" + step + " Storing Party ID")
//notificationPage.getPartyID("Results_Data\\PartyID.xlsx","PartyID")
